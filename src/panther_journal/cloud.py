...
def register(group):
    ...
    from panther_journal.narration import narration
    from panther_journal.soundtrack import soundtrack
    ...
    group.add_command(narration)
    group.add_command(soundtrack)
    video.add_command(production)
