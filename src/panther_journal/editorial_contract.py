...
BRIEFS = {
    ...
    "corrected-transcript": "Independently audit every proposed correction against the raw utterance and pinned context. Fail if unsupported, if it changes meaning/identity/numbers, deletes table talk, fills missing sound, or treats game expectations as proof of speech. Passing means plausible AI corrections, not human verification. Return a review; trusted code publishes the candidate only if passed.",
    ...
    "novel-proof": "Check the copyedited Markdown reading proof, including headings, paragraph breaks and dialogue punctuation. Return final full chapter text and a separate proof report. This is a digital manuscript proof, not a claim of typeset print proofing.",
    "novel-chapter": "Independently quality-check the final reading proof against sources, brief and edits. Require compelling scene-level storytelling, coherent POV, resolved developmental issues, faithful consequential outcomes, and disclosed inventions. Return pass/fail with reasons; do not rewrite the chapter in this review.",
